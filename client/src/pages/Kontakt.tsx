...
export default function Kontakt() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-5xl font-bold text-green-700 mb-10">Kontakt</h1>
      <div className="bg-white rounded-xl shadow-2xl p-8 grid md:grid-cols-2 gap-8">
        <div>
          ...
          <p className="text-lg mb-2"><strong>Telefon:</strong> <a href={`tel:${data.phone}`} className="text-green-600 hover:underline">{data.phone}</a></p>
          <p className="text-lg mb-6"><strong>E-post:</strong> <a href={`mailto:${data.email}`} className="text-green-600 hover:underline">{data.email}</a></p>
        </div>
        <div>
